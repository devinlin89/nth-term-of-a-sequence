...
[![Nth Term of a Sequence](docs/images/nth_term_screenshot.png)](docs/images/nth_term_screenshot.png)
...
* **Multiple sequence types:** Supports linear, quadratic, cubic, and exponential sequences.
...
The calculator can also identify quadratic, cubic, and exponential sequences when sufficient terms are provided.
...
The calculator is designed to recognize only **linear, quadratic, cubic, and exponential sequences**. Sequences that do not match one of these supported patterns are classified as unknown.
